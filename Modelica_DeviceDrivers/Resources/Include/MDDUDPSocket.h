...
void * MDD_udpConstructor(int port, int bufferSize, int useNonBlockingRecv)
{
	...
	udp->receivedBytes = 0;
	udp->useNonBlockingRecv = useNonBlockingRecv;
...
/** A blocking function for receiving UDP messages.
*
* @param p_udp pointer address to the udp socket data structure
*/
int MDD_udpReceiveBlocking(void * p_udp) 
{
